...
public class SwiftFlutterJsStablePlugin: NSObject, FlutterPlugin {
    private var jsEngineMap = [Int: JSContextFoundation]()
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "io.hakan.flutter_js_stable", binaryMessenger: registrar.messenger())
        let instance = SwiftFlutterJsStablePlugin()
