package io.hakan.flutter_js_stable
...
/** FlutterJsStablePlugin */
class FlutterJsStablePlugin : FlutterPlugin, MethodCallHandler {
    ...
    private fun onAttachedToEngine(applicationContext: android.content.Context, messenger: BinaryMessenger) {
        ...
        methodChannel = MethodChannel(messenger, "io.hakan.flutter_js_stable")
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            val instance = FlutterJsStablePlugin()
...
//             val evalResult = FlutterJsStablePlugin.jsEngineMap[engineId]!!.eval(code!!)
